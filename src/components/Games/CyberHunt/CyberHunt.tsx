    ...
    <div className={`transition-all ${isFullscreen ? 'fixed inset-0 z-50 p-2 bg-[#09090b]' : 'w-full space-y-4 pb-12'}`}>
      ...
      <div className={`rounded-xl border-2 border-zinc-800 bg-[#0c0c0f] comic-shadow-lg overflow-hidden flex flex-col ${
        ...
        <div className="bg-[#18181b] border-b border-zinc-800 px-3 pt-2 pb-0 flex items-center justify-between gap-2 overflow-x-auto select-none">
          ...
          <div className="flex items-center gap-1.5 flex-1 overflow-x-auto no-scrollbar">
            {tabs.map((tab) => {
              ...
              return (
                <div
                  ...
                  className={`group flex items-center gap-2 px-3 py-1.5 rounded-t-lg text-xs font-medium cursor-pointer transition-colors shrink-0 max-w-[200px] border-t border-x ${
                    isActive
                ...
                >
                  ...
                  {tab.type === 'amazon_fake' && <AlertTriangle className="w-3 h-3 text-red-400 shrink-0" />}
                  ...
                  {tab.canClose && (
                    <button
                      ...
                      className="p-0.5 rounded hover:bg-zinc-700 text-zinc-500 hover:text-white transition-colors cursor-pointer"
                      title="Close tab"
                    >
                      <X className="w-3 h-3" />
                    </button>
            ...
            <button
              ...
              className="p-1 text-zinc-400 hover:text-white hover:bg-zinc-800 rounded-md transition-colors cursor-pointer shrink-0"
              title="Open New Tab"
            >
        ...
        <div className="bg-[#121214] border-b border-zinc-800 px-3 py-2 flex items-center gap-2 text-xs">
          ...
          <div className="flex items-center gap-1 text-zinc-400 shrink-0">
            <button 
              ...
              className={`p-1 rounded cursor-pointer ${historyIndex > 0 ? 'hover:text-white hover:bg-zinc-800' : 'opacity-40 cursor-not-allowed'}`}
              title="Back"
            >
            ...
            <button 
              ...
              className={`p-1 rounded cursor-pointer ${historyIndex < navHistory.length - 1 ? 'hover:text-white hover:bg-zinc-800' : 'opacity-40 cursor-not-allowed'}`}
              title="Forward"
            >
            ...
            <button 
              onClick={handleRefresh} 
              className={`p-1 hover:text-white rounded hover:bg-zinc-800 cursor-pointer transition-transform ${isRefreshing ? 'animate-spin' : ''}`}
              title="Reload Page"
            >
            ...
            <button 
              ...
              className="p-1 hover:text-white rounded hover:bg-zinc-800 cursor-pointer"
              title="Home Page"
            >
          ...
          {/* Omnibox URL Bar */}
          <form onSubmit={handleUrlSubmit} className="flex-1 flex items-center gap-2 bg-[#18181b] border border-zinc-700/80 focus-within:border-zinc-400 rounded-lg px-2.5 py-1 text-zinc-300 font-mono text-xs transition-colors">
            ...
            >
              {activeTab.type === 'amazon_fake' || activeTab.type === 'party_invite' ? (
                <ShieldAlert className="w-3.5 h-3.5 text-red-400 hover:text-red-300" />
              ) : activeTab.type === 'history' || activeTab.type === 'newtab' ? (
                <Info className="w-3.5 h-3.5 text-blue-400 hover:text-blue-300" />
              ) : (
                <Lock className="w-3.5 h-3.5 text-green-400 hover:text-green-300" />
              )}
            </button>
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 bg-[#09090b] text-zinc-200 overflow-y-auto p-4 sm:p-6">
              ...
              <div className="max-w-2xl mx-auto space-y-6 pt-4 animate-in fade-in duration-200">
                <div className="text-center space-y-4">
                  ...
                  <form
                    ...
                    className="flex items-center gap-3 max-w-lg mx-auto bg-[#18181b] border border-zinc-700/80 hover:border-zinc-500 rounded-full px-4 py-2.5 shadow-lg transition-colors"
                  >
                ...
                {hasSearched && (
                  <div className="space-y-4 pt-4 border-t border-zinc-800">
                    ...
                    <div className="p-4 rounded-xl bg-[#121214] border border-zinc-800 hover:border-zinc-700 transition-colors space-y-1.5">
                      <div className="flex items-center gap-2 text-xs">
                        <span className="font-mono text-zinc-300 font-semibold">https://www.amazon.ti</span>
                      ...
                      <p className="text-xs text-zinc-400 leading-relaxed">
                        Sign in immediately to claim limited student vouchers and discounted computer science hardware. Unverified clearance promotion.
                      </p>
                    </div>
                    ...
                    <div className="p-4 rounded-xl bg-[#121214] border border-zinc-800 hover:border-zinc-700 transition-colors space-y-1.5">
                      <div className="flex items-center gap-2 text-xs">
                        <span className="font-mono text-zinc-300 font-semibold">https://www.amazon.com</span>
                        <span className="px-1.5 py-0.2 rounded bg-green-500/20 text-green-300 text-[10px] font-mono border border-green-500/40 flex items-center gap-1">
                          <CheckCircle2 className="w-2.5 h-2.5" /> Verified Store
                        </span>
                      </div>
                      <button
                        onClick={() => navigateCurrentTab('amazon_legit', 'https://www.amazon.com/cyber-security-book', 'Amazon.com: Online Store')}
            ...
            {/* PAGE 2: FAKE AMAZON (AMAZON.TI) */}
            {activeTab.type === 'amazon_fake' && (
              <div className="max-w-sm mx-auto p-6 bg-[#121214] border border-zinc-800 rounded-2xl space-y-4 text-center animate-in fade-in duration-200">
                <div className="text-2xl font-bold tracking-tight text-white">
                  amazon<span className="text-amber-400">.ti</span>
                </div>
                
                <div className="bg-red-950/20 border border-red-500/40 rounded-lg p-2.5 text-left text-xs text-red-300 flex items-start gap-2">
                  <AlertTriangle className="w-4 h-4 text-red-400 shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold">Caution: </span>
                    Inspect the domain extension (<code className="font-mono bg-red-950/60 px-1 rounded">.ti</code>). Official Amazon operates on <code className="font-mono bg-green-950/60 px-1 rounded">.com</code> or <code className="font-mono bg-green-950/60 px-1 rounded">.in</code>.
                  </div>
                </div>
                ...
                <form onSubmit={handleFakeAmazonSubmit} className="space-y-3 text-left">
                  <div>
                    <label className="text-[11px] text-zinc-400">School Email or Mobile number</label>
                    <input
                      type="text"
                      required
                      value={fakeEmail}
                      ...
                      className="w-full mt-1 bg-[#18181b] border border-zinc-800 focus:border-zinc-500 rounded-lg p-2 text-xs text-white"
                    />
                  </div>
                  <div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-2.5 rounded-lg bg-amber-400 hover:bg-amber-300 text-black font-bold text-xs cursor-pointer transition-colors shadow-md"
                  >
                ...
                <div className="pt-2 border-t border-zinc-800">
                  ...
                  >
                    Leave dangerous site & return to Google
                  </button>
                </div>
              </div>
            )}
            ...
            {activeTab.type === 'amazon_legit' && (
              <div className="max-w-3xl mx-auto space-y-5 animate-in fade-in duration-200">
                <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
                  ...
                  <div className="flex items-center gap-1.5 text-xs font-mono text-green-400 bg-green-950/20 border border-green-800/50 px-2 py-0.5 rounded">
                    <Lock className="w-3 h-3" />
                    <span>SSL 256-bit Encrypted • Verified Merchant</span>
                  </div>
                </div>

                <div className="p-5 bg-[#121214] border border-zinc-800 rounded-2xl flex flex-col md:flex-row items-center gap-5 shadow-lg">
                  <div className="w-32 h-36 rounded-xl bg-zinc-800 border border-zinc-700 flex flex-col items-center justify-center text-white shrink-0 p-3 text-center">
                  ...
                  <div className="shrink-0 w-full md:w-auto">
                    <button
                      ...
                      className="w-full md:w-auto px-5 py-3 rounded-xl bg-amber-400 hover:bg-amber-300 text-black font-bold text-xs cursor-pointer transition-colors shadow-md flex items-center justify-center gap-2"
                    >
              ...
              <div className="max-w-4xl mx-auto space-y-4 animate-in fade-in duration-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    <div className="text-xs font-bold text-zinc-400 px-2 uppercase tracking-wider">
                      Inbox Messages
                    </div>

                    {/* Email Item 1 (Phishing Trigger) */}
                    <div className="p-3 rounded-xl bg-[#141417] border border-red-500/50 space-y-1 cursor-pointer">
                    ...
                    {/* Email Item 2 */}
                    <div className="p-3 rounded-xl bg-[#101012] border border-zinc-800/80 space-y-1 opacity-70">
                      <div className="flex items-center justify-between text-xs">
                  ...
                  <div className="md:col-span-2 bg-[#121214] border border-zinc-800 rounded-2xl p-5 space-y-4">
                    ...
                    <div className="p-4 rounded-xl bg-[#18181b] border border-zinc-700 text-center space-y-2.5">
                      <PartyPopper className="w-8 h-8 text-amber-400 mx-auto" />
                      <div className="text-xs font-bold text-white">
                        Kabir's 16th Birthday Celebration Card
                      </div>
                      <p className="text-[11px] text-zinc-400">
                        External Site: <code className="text-amber-300 font-mono">http://party-rsvp-event-verify.com/accept</code>
                      </p>

                      <button
                        onClick={() => openNewTab('party_invite', 'http://party-rsvp-event-verify.com/accept', 'Party RSVP Form')}
                        className="px-4 py-2 rounded-lg bg-white hover:bg-zinc-200 text-black font-bold text-xs cursor-pointer transition-colors inline-flex items-center gap-1.5"
                      >
                    ...
                    {task2Done && (
                      <div className="p-3 rounded-xl bg-green-950/20 border border-green-800/60 text-xs text-green-300 flex items-center gap-2">
            ...
            {/* PAGE 5: PARTY RSVP PHISHING SITE */}
            {activeTab.type === 'party_invite' && (
              <div className="max-w-md mx-auto p-6 bg-[#121214] border border-zinc-800 rounded-2xl space-y-4 text-center animate-in fade-in duration-200">
                <PartyPopper className="w-10 h-10 text-amber-400 mx-auto" />
                <h3 className="text-base font-bold text-white">
                  Confirm Birthday Party Attendance
                </h3>

                <div className="bg-red-950/20 border border-red-500/40 rounded-lg p-2.5 text-left text-xs text-red-300 space-y-1">
                  <div className="font-bold flex items-center gap-1.5">
                    <AlertTriangle className="w-3.5 h-3.5" /> Phishing Trap Detected!
                  </div>
                  <p className="text-[11px] leading-relaxed">
                    Notice how this external site asks for your <strong>Tmail password</strong>. A genuine birthday RSVP never asks for your email password!
                  </p>
                </div>

                <div className="bg-[#18181b] border border-zinc-800 rounded-xl p-3.5 text-left space-y-2.5 text-xs">
                  <div>
                    <label className="text-[11px] text-zinc-400">Your Tmail Address</label>
                    <input
                      type="text"
                      readOnly
                      defaultValue="student@thekhaitanschool.org"
                      className="w-full mt-1 bg-zinc-900 border border-zinc-700/80 rounded p-2 text-xs text-zinc-300"
                    />
                  </div>
                  <div>
                    <label className="text-[11px] text-zinc-400">Tmail Account Password (Mandatory)</label>
                    <input
                      type="password"
                      placeholder="Enter your Tmail password"
                      className="w-full mt-1 bg-zinc-900 border border-zinc-700/80 rounded p-2 text-xs text-white"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  <button
                    ...
                    className="py-2.5 px-3 rounded-xl border border-red-500/60 bg-red-950/20 hover:bg-red-950/40 text-red-300 font-bold text-xs transition-colors cursor-pointer"
                  >
                    Fill Details & Submit
                  </button>
                  ...
                  <button
                    ...
                    className="py-2.5 px-3 rounded-xl bg-white hover:bg-zinc-200 text-black font-bold text-xs transition-colors cursor-pointer shadow-md"
                  >
            ...
            {activeTab.type === 'download_portal' && (
              <div className="max-w-3xl mx-auto space-y-5 animate-in fade-in duration-200">
                <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
                  <div>
                    <h3 className="text-base font-bold text-white">School Cloud Storage Hub</h3>
                    <p className="text-xs text-zinc-400 font-mono">school-cloud.khaitan.org • Official Academic File Repository</p>
                  </div>
                  <span className="text-xs font-mono text-green-400 bg-green-950/20 px-2 py-0.5 rounded border border-green-800/40">
                    Network: Khaitan Intranet
                  </span>
                </div>

                <div className="space-y-4">
                  {/* Deceptive Fake Malvertising Banner */}
                  <div className="p-4 rounded-xl border border-red-500/40 bg-red-950/10 text-center space-y-2">
                    <div className="text-[10px] uppercase font-mono text-zinc-500 flex items-center justify-center gap-1">
                      <AlertTriangle className="w-3 h-3 text-red-400" />
                      <span>Sponsored Advertisement Banner</span>
                    </div>

                    <button
                      onClick={handleFakeDownload}
                      className="py-3 px-6 rounded-xl bg-green-500 hover:bg-green-400 text-black font-black text-sm cursor-pointer transition-colors shadow-lg animate-pulse"
                    >
                  ...
                  {/* Real Document Link */}
                  <div className="p-4 rounded-xl bg-[#121214] border border-zinc-800 hover:border-zinc-700 transition-colors flex items-center justify-between shadow-sm">
                    <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-lg bg-zinc-800 hover:bg-zinc-700 border border-zinc-600 text-white font-semibold text-xs cursor-pointer transition-colors flex items-center gap-1.5"
                    >
              ...
              <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in duration-200">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-800 pb-4">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h3 className="text-base font-bold text-white">Browsing History & Security Audit</h3>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="bg-[#18181b] border border-zinc-700/80 rounded-lg pl-8 pr-3 py-1.5 text-xs text-white placeholder:text-zinc-500 focus:outline-none focus:border-zinc-400 w-52"
                      />
                    </div>

                    <button
                      onClick={clearAllHistory}
                      className="px-3 py-1.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-white text-xs font-medium cursor-pointer transition-colors border border-zinc-700"
                    >
                      Clear Data
                    </button>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="p-3.5 rounded-xl bg-[#121214] border border-zinc-800 space-y-1">
                ...
                <div className="space-y-2">
                  {filteredHistory.length === 0 ? (
                    <div className="p-8 text-center text-zinc-500 text-xs bg-[#121214] rounded-xl border border-zinc-800">
                    ...
                    filteredHistory.map((item) => (
                      <div
                        key={item.id}
                        className="p-3 rounded-xl bg-[#121214] border border-zinc-800/80 hover:border-zinc-700 transition-colors flex items-center justify-between gap-3 text-xs"
                      >
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center gap-2">
                              ...
                              {item.category === 'phishing' && (
                                <span className="px-1.5 py-0.2 rounded bg-red-950/60 border border-red-500/50 text-red-300 text-[10px] font-mono shrink-0">
                                  Typosquat Threat
                                </span>
                              )}
                              {item.category === 'threat' && (
                                <span className="px-1.5 py-0.2 rounded bg-amber-950/60 border border-amber-500/50 text-amber-300 text-[10px] font-mono shrink-0">
                                  Credential Harvest
                                </span>
                              )}
                              {item.category === 'safe' && (
                                <span className="px-1.5 py-0.2 rounded bg-green-950/40 border border-green-600/40 text-green-300 text-[10px] font-mono shrink-0">
                                  Verified Safe
                                </span>
                              )}
                            </div>
            ...
            {activeTab.type === 'newtab' && (
              <div className="max-w-2xl mx-auto space-y-6 pt-8 text-center animate-in fade-in duration-200">
                ...
                <form
                  ...
                  className="flex items-center gap-3 max-w-lg mx-auto bg-[#18181b] border border-zinc-700 rounded-full px-4 py-2.5 shadow-lg"
                >
                  <Search className="w-4 h-4 text-zinc-400" />
                  <input
                    type="text"
                ...
                <div className="pt-4">
                  <div className="text-xs font-semibold text-zinc-400 mb-3">Quick Navigation Shortcuts</div>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-md mx-auto">
                    <button
                      onClick={() => navigateCurrentTab('google', 'https://www.google.com', 'Google')}
                      className="p-3 bg-[#121214] border border-zinc-800 hover:border-zinc-600 rounded-xl space-y-1.5 transition-colors cursor-pointer text-center"
                    >
                    ...
                    >
                      ...
                      <div className="text-xs font-semibold text-white">Tmail</div>
                    </button>
                    ...
                    >
                      ...
                      <div className="text-xs font-semibold text-white">Cloud Files</div>
                    </button>
          ...
          {showTodoSidebar && (
            <div className="w-80 border-l border-zinc-800 bg-[#101013] flex flex-col shrink-0 select-none overflow-y-auto">
              {/* Header */}
              ...
              <div className="p-3 space-y-3 flex-1 overflow-y-auto">
                ...
                <div className={`p-3.5 rounded-xl border transition-all ${
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-2">
                      {task1Done ? (
                        ...
                        <div className="w-4 h-4 rounded-full border border-zinc-500 flex items-center justify-center text-[10px] font-mono text-zinc-300">
                          1
                        </div>
                      )}
                      <span className="text-xs font-bold text-white">Safe Amazon Order</span>
                    </div>
                  ...
                  {!task1Done && (
                    <button
                      ...
                      className="mt-2.5 w-full py-1.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-white font-medium text-xs flex items-center justify-center gap-1 cursor-pointer transition-colors"
                    >
                ...
                <div className={`p-3.5 rounded-xl border transition-all ${
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-white">Inspect Party RSVP</span>
                    </div>
                ...
                <div className={`p-3.5 rounded-xl border transition-all ${
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-white">Download Project PDF</span>
                    </div>
                ...
                {completedCount === 3 && (
                  <div className="p-4 rounded-xl bg-green-950/30 border border-green-500/60 text-center space-y-2">
      ...
      {showCertModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-150">
          <div className="max-w-sm w-full bg-[#141417] border border-zinc-700 rounded-2xl p-5 text-left space-y-4 shadow-2xl">
            <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-4 h-4 text-zinc-300" />
                <span className="text-sm font-bold text-white">Site Security Information</span>
              </div>
              <button 
            ...
            <div className="space-y-3 text-xs">
              ...
              <div>
                ...
                {activeTab.type === 'amazon_fake' || activeTab.type === 'party_invite' ? (
                  <div className="text-red-400 font-bold mt-0.5 flex items-center gap-1.5">
                    <AlertTriangle className="w-3.5 h-3.5" />
                    <span>Untrusted / Malicious Phishing Indicator</span>
                  </div>
                ) : (
                  <div className="text-green-400 font-bold mt-0.5 flex items-center gap-1.5">
                    <CheckCircle2 className="w-3.5 h-3.5" />
              ...
              <div>
                ...
                <div className="text-zinc-300 mt-0.5">Encrypted sandbox storage only.</div>
              </div>
            </div>

            <button
              onClick={() => setShowCertModal(false)}
              className="w-full py-2 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-white font-medium text-xs cursor-pointer transition-colors"
            >
              Close Inspector
            </button>
          </div>
      ...
      {resultModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-150">
          <div className="max-w-md w-full bg-[#121214] border border-zinc-800 rounded-2xl p-6 text-center space-y-4 shadow-2xl">
            ...
            <div>
              <h3 className="text-base font-bold text-white">{resultModal.title}</h3>
            ...
            <button
              ...
              className="w-full py-2.5 rounded-lg bg-white hover:bg-zinc-200 text-black font-semibold text-xs cursor-pointer transition-colors"
            >
              Continue Browsing
            </button>
          </div>
